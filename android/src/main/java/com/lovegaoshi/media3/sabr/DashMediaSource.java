...
import com.lovegaoshi.media3.sabr.PlayerEmsgHandler.PlayerEmsgCallback;
...
import com.lovegaoshi.media3.sabr.manifest.UtcTimingElement;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.lovegaoshi.media3.sabr.manifest.Period period = manifest.getPeriod(periodIndex);
